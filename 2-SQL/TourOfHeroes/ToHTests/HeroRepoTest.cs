...
{  
    /// <summary>
    /// Test class for the data access methods in my DL (Data Layer)
    /// </summary>
    public class HeroRepoTest
    {
        private readonly DbContextOptions<Entity.BatchDBContext> options;
        public HeroRepoTest(){
            options = new DbContextOptionsBuilder<Entity.BatchDBContext>()
        ...
        {
            using(var context = new Entity.BatchDBContext(options)){
                //Arrange
        ...
        public void AddHeroShouldAddHero()
        {
            ...
            using (var assertContext = new Entity.BatchDBContext(options)){
